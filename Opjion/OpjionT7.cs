...
public readonly struct Opjion<T0, T1, T2, T3, T4, T5, T6> : IOpjion<T0, T1, T2, T3, T4, T5, T6>, IEquatable<Opjion<T0, T1, T2, T3, T4, T5, T6>> {
    ...
    public override bool Equals(object obj) => 
        obj is Opjion<T0, T1, T2, T3, T4, T5, T6> o && 
        _type == o._type && 
        Equals(_obj, o._obj);

    public bool Equals(Opjion<T0, T1, T2, T3, T4, T5, T6> other) => _type == other._type && Equals(_obj, other._obj);

    public static bool operator ==(Opjion<T0, T1, T2, T3, T4, T5, T6> left, Opjion<T0, T1, T2, T3, T4, T5, T6> right) => left.Equals(right);
    public static bool operator !=(Opjion<T0, T1, T2, T3, T4, T5, T6> left, Opjion<T0, T1, T2, T3, T4, T5, T6> right) => !left.Equals(right);

    public static Opjion<T0, T1, T2, T3, T4, T5, T6> FromT0(T0 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6> FromT1(T1 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6> FromT2(T2 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6> FromT3(T3 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6> FromT4(T4 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6> FromT5(T5 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6> FromT6(T6 v) => new(v);
    
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6>(T0 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6>(T1 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6>(T2 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6>(T3 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6>(T4 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6>(T5 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6>(T6 v) => new(v);
}