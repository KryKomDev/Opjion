...
public readonly struct Opjion<T0, T1, T2, T3, T4, T5> : IOpjion<T0, T1, T2, T3, T4, T5>, IEquatable<Opjion<T0, T1, T2, T3, T4, T5>> {
    ...
    public override bool Equals(object obj) => 
        obj is Opjion<T0, T1, T2, T3, T4, T5> o && 
        _type == o._type && 
        Equals(_obj, o._obj);

    public bool Equals(Opjion<T0, T1, T2, T3, T4, T5> other) => _type == other._type && Equals(_obj, other._obj);

    public static bool operator ==(Opjion<T0, T1, T2, T3, T4, T5> left, Opjion<T0, T1, T2, T3, T4, T5> right) => left.Equals(right);
    public static bool operator !=(Opjion<T0, T1, T2, T3, T4, T5> left, Opjion<T0, T1, T2, T3, T4, T5> right) => !left.Equals(right);

    public static Opjion<T0, T1, T2, T3, T4, T5> FromT0(T0 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5> FromT1(T1 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5> FromT2(T2 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5> FromT3(T3 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5> FromT4(T4 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5> FromT5(T5 v) => new(v);
    
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5>(T0 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5>(T1 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5>(T2 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5>(T3 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5>(T4 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5>(T5 v) => new(v);
}