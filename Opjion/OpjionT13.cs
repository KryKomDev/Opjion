...
public readonly struct Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> : IOpjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>, IEquatable<Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> {
    ...
    public override bool Equals(object obj) => 
        obj is Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> o && 
        _type == o._type && 
        Equals(_obj, o._obj);

    public bool Equals(Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> other) => _type == other._type && Equals(_obj, other._obj);

    public static bool operator ==(Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> left, Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> right) => left.Equals(right);
    public static bool operator !=(Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> left, Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> right) => !left.Equals(right);

    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT0(T0 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT1(T1 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT2(T2 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT3(T3 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT4(T4 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT5(T5 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT6(T6 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT7(T7 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT8(T8 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT9(T9 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT10(T10 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT11(T11 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> FromT12(T12 v) => new(v);
    
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T0 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T1 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T2 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T3 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T4 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T5 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T6 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T7 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T8 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T9 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T10 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T11 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(T12 v) => new(v);
}