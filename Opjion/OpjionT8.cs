...
public readonly struct Opjion<T0, T1, T2, T3, T4, T5, T6, T7> : IOpjion<T0, T1, T2, T3, T4, T5, T6, T7>, IEquatable<Opjion<T0, T1, T2, T3, T4, T5, T6, T7>> {
    ...
    public override bool Equals(object obj) => 
        obj is Opjion<T0, T1, T2, T3, T4, T5, T6, T7> o && 
        _type == o._type && 
        Equals(_obj, o._obj);

    public bool Equals(Opjion<T0, T1, T2, T3, T4, T5, T6, T7> other) => _type == other._type && Equals(_obj, other._obj);

    public static bool operator ==(Opjion<T0, T1, T2, T3, T4, T5, T6, T7> left, Opjion<T0, T1, T2, T3, T4, T5, T6, T7> right) => left.Equals(right);
    public static bool operator !=(Opjion<T0, T1, T2, T3, T4, T5, T6, T7> left, Opjion<T0, T1, T2, T3, T4, T5, T6, T7> right) => !left.Equals(right);

    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7> FromT0(T0 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7> FromT1(T1 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7> FromT2(T2 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7> FromT3(T3 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7> FromT4(T4 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7> FromT5(T5 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7> FromT6(T6 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7> FromT7(T7 v) => new(v);
    
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7>(T0 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7>(T1 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7>(T2 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7>(T3 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7>(T4 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7>(T5 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7>(T6 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7>(T7 v) => new(v);
}