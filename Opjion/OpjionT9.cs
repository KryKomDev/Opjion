...
public readonly struct Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> : IOpjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>, IEquatable<Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>> {
    ...
    public override bool Equals(object obj) => 
        obj is Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> o && 
        _type == o._type && 
        Equals(_obj, o._obj);

    public bool Equals(Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> other) => _type == other._type && Equals(_obj, other._obj);

    public static bool operator ==(Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> left, Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> right) => left.Equals(right);
    public static bool operator !=(Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> left, Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> right) => !left.Equals(right);

    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> FromT0(T0 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> FromT1(T1 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> FromT2(T2 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> FromT3(T3 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> FromT4(T4 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> FromT5(T5 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> FromT6(T6 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> FromT7(T7 v) => new(v);
    public static Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8> FromT8(T8 v) => new(v);
    
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T0 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T1 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T2 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T3 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T4 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T5 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T6 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T7 v) => new(v);
    public static implicit operator Opjion<T0, T1, T2, T3, T4, T5, T6, T7, T8>(T8 v) => new(v);
}